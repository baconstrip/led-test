...
public class LedSubsystem extends SubsystemBase {
  ...
  private static final FireAnimation FLAME_ANIMATION = new FireAnimation(1, 0.15, STRIP_LENGTH, 0.4, 0.4, false, LED_OFFSET);
  private static final SingleFadeAnimation MATCH_IDLE_ANIMATION = new SingleFadeAnimation(255, 0, 255, 0, 0, STRIP_LENGTH, LED_OFFSET);
  private static final StrobeAnimation INTAKE_FLASH_ANIMATION = new StrobeAnimation(242, 200, 82, 0, 0, STRIP_LENGTH, LED_OFFSET);
  private static final StrobeAnimation ALIGNMENT_FLASH_ANIMATION = new StrobeAnimation(30, 150, 130, 0, 0, STRIP_LENGTH, LED_OFFSET);
  private static final StrobeAnimation SCORING_SOLID_ANIMATION = new StrobeAnimation(32, 250, 61, 0, 1, STRIP_LENGTH, LED_OFFSET);
  ...
  /**
   * updateLedsForSensors is a command that is used during robot setup to help 
   * check the various sensors on the robot. Will need to be connected to the 
   * sensors' subsystems on the actual bot
   */
  public void updateLedsForSensors(BooleanSupplier inSensor, BooleanSupplier funnelSensor, BooleanSupplier elevatorSensor) {
